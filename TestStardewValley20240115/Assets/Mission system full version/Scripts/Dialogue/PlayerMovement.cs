...
public class Player_1Movement : MonoBehaviour
{
    public static Player_1Movement instance;
    ...
    {
        if (rb.velocity.y < 0)//MARKER 角色下落时，速度会越来越快 Player_1 Falling down, Faster Speed!
        {
